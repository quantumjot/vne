...
def test_simulated_image_rng():
    ...
    data_rng1_0 = create_heterogeneous_image(
        shape=shape, n_objects=n_objects, rng=rng
    )
    data_rng1_1 = create_heterogeneous_image(
        shape=shape, n_objects=n_objects, rng=rng
    )
    data_rng2_0 = create_heterogeneous_image(
        shape=shape, n_objects=n_objects, rng=np.random.default_rng(seed)
    )
